package com.microservice.CheckInService.apiConfig;
...
@OpenAPIDefinition(
        info = @Info(
                title = "Check-In Microservice API",                    // API Title
                version = "v1",                                  // API Version
                description = "API Gateway for flight booking system",    // API Description
